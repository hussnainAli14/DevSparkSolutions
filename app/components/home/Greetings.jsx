    ...
    <GradientWrapper>
      <MaxWidthWrapper className="md:flex-row md:justify-between">
        ...
        >
          <H1>
            We &apos; re{" "}
            <span className="blue-text gradient-text">DevCrew.</span>
          </H1>
          <H2>Pleased to meet you.</H2>
          <Paragraph>
            Located in Islamabad, Pakistan, DevCrew is a dynamic digital agency
            specializing in a spectrum of services tailored to elevate your
            brand presence. With a keen focus on Web Development, Mobile App
            Development, Graphic Design, SEO, Social Media Marketing Agency
          ...
          <Paragraph py="py-1" className="pb-4">
            ...
            lasting impression on your audience, partner with DevCrew for
